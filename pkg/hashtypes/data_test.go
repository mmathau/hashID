...
var tests = []testCases{
	...
	{
		name: "VeraCryptSHA256XTS1536bitBootMode",
		hashes: []string{
		...
		want: "VeraCrypt SHA256 + XTS 1536 bit + boot-mode",
	},
	{
		name: "VeraCryptStreebog512XTS512bit",
		hashes: []string{
		...
		want: "VeraCrypt Streebog-512 + XTS 512 bit",
	},
	{
		name: "VeraCryptStreebog512XTS1024bit",
		hashes: []string{
		...
		want: "VeraCrypt Streebog-512 + XTS 1024 bit",
	},
	{
		name: "VeraCryptStreebog512XTS1536bit",
		hashes: []string{
		...
		want: "VeraCrypt Streebog-512 + XTS 1536 bit",
	},
	{
		name: "VeraCryptStreebog512XTS512bitBootMode",
		hashes: []string{
		...
		want: "VeraCrypt Streebog-512 + XTS 512 bit + boot-mode",
	},
	{
		name: "VeraCryptStreebog512XTS1024bitBootMode",
		hashes: []string{
		...
		want: "VeraCrypt Streebog-512 + XTS 1024 bit + boot-mode",
	},
	{
		name: "VeraCryptStreebog512XTS1536bitBootMode",
		hashes: []string{
	...
	{
		name: "ENCsecurityDatavaultMD5NoKeychain",
		hashes: []string{
	...
	},
	{
		...
		want: "Bitcoin raw private key (P2PKH), uncompressed",
	},
	{
		name: "BitcoinRawPrivateKeyP2WPKHBech32Compressed",
		hashes: []string{
	...
	},
	{
		...
		want: "Bitcoin raw private key (P2WPKH, Bech32), uncompressed",
	},
	{
		name: "BitcoinRawPrivateKeyP2SHP2WPKHCompressed",
		hashes: []string{
